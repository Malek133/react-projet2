...
interface IProps {
  ...
  setSelected: (categorie: ICategory) => void;
}
    ...
    <Listbox value={selected} onChange={setSelected}>
      ...
      {({ open }) => (
        <>
          ...
          leading-6 text-gray-900">Category</Listbox.Label>
                    ...
                    {({ selected, active }) => (
                      <>
                        <div className="flex items-center">
                          <img src={categorie.imageURL} alt="" className="h-5 w-5 flex-shrink-0 rounded-full" />
                          <span
